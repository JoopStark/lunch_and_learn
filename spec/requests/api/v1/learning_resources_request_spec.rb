...
describe "Request tourist spot request" do
  ...
  #  make_api_request
    ...
    expect(data[:attributes][:images][0][:url]).to eq("https://images.unsplash.com/photo-1467269204594-9661b134dd2b?ixid=M3w1Mjc3MTd8MHwxfHNlYXJjaHwxfHxnZXJtYW55fGVufDB8fHx8MTcwMDAyNjcwNHww&ixlib=rb-4.0.3")
  end
